...
body.overview .slide{height:auto;cursor:pointer;scroll-snap-align:none;border-radius:12px;box-shadow:0 12px 34px -14px rgba(0,0,0,.6);outline:2px solid transparent;transition:outline-color .18s,transform .18s}
body.overview .slide:hover{transform:translateY(-4px);outline-color:var(--accent)}
body.overview .slide-inner{position:relative;width:100vw;height:100vh;transform-origin:top left;overflow:hidden}
