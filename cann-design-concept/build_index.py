...
/* 必须显式盖掉各分册横向用的 height/overflow/display，否则还是横排/滚不动 */
...
/* 纵向翻页：原生 scroll-snap（同参考 demo）——每页 100vh + 强制吸附，静止只显一页、翻=吸附到下一页 */
...
/* ===== 纵向 scroll-snap 翻页（同参考 demo）+ 右侧点 + 控制栏 + 总览 + 全屏 ===== */
...
/* 谁滚进视口 ≥55% 谁就是当前页（原生滚 / scrollIntoView 跳转都覆盖）*/
